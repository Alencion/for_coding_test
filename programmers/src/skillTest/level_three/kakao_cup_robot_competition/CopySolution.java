...
//        this.n = board.length;
//
//        Queue<Solution.Robot> queue = new LinkedList<>();
//        queue.add(new Solution.Robot(0, 0, 0, 0)); // 초기 로봇 위치
//
...
//                queue.add(new Solution.Robot(nx, ny, dir, time + 1));
//            }
//
...
//                visit[x][y][ndir] = true;
//                queue.add(new Solution.Robot(x, y, ndir, time + 1));
//            }
//
...
//                queue.add(new Solution.Robot(nx, ny, ndir, time + 1));
//            }
//        }
//        return -1;
//    }
...
//        int time;
//
//        Robot(int x, int y, int direct, int time) {
//            this.x = x;
//            this.y = y;
//            this.direct = direct;
//            this.time = time;
...
//            return "time:" + time + " (" + x + "," + y + ") (" + getOtherX() + "," + getOtherY() + ") dir:" + direct;
//        }
//    }
//}
//
